...
- 支持切回微信读书原版界面。
- 单行阅读支持滚轮逐字移动、键盘换行、自动滚动，并在页尾自动续接下一页。
...
点击齿轮可调整窗口长度、背景颜色与透明度、字体颜色与透明度、字体、字号、粗细和自动滚动速度。背景色和字体色旁的“取色”按钮可以从屏幕任意位置取色。读到当前页末尾时会自动加载下一页正文；再次从阅读菜单选择“单行阅读”会更新正文并复用现有窗口，不会重复创建多个窗口。
