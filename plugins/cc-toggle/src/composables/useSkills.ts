...
import type {
  NestSkill, SkillInDir, SkillRepo, ProjectTarget, DeployEntry,
  DeployResult, SyncResult, SkillListResult, SkillInstallResult,
  SkillDirs, ConfigPaths, SuccessResult, IdResult,
} from '../types/ztools-cctoggle'

const ALL_APPS = ['codex', 'claude', 'gemini', 'opencode', 'openclaw'] as const
const APP_LABELS: Record<string, string> = {
  codex: 'Codex', claude: 'Claude', gemini: 'Gemini', opencode: 'OpenCode', openclaw: 'OpenClaw',
}
