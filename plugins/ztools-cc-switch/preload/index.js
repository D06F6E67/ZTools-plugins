...
const deepLinkManager = createDeepLinkManager({ configManager, extensionManager, skillManager, fetchImpl: outboundFetch, saveUsageScript: (providerId, config) => usageScriptManager.saveConfig(providerId, config) })
